...
def show_about():   
    ...
    Button(about_footer_frame,image=git_ICON,background='#e2e2e2',command=lambda:(webbrowser.open('github.com/BlackTheives', new=0, autoraise=True))).pack(side=LEFT,padx=6,pady=10)
    Button(about_footer_frame,image=hack_ICON,background='#e2e2e2',command=lambda:(webbrowser.open('https://www.facebook.com/BlackThievesAnonymous', new=0, autoraise=True))).pack(side=RIGHT,padx=6,pady=10)
...
def  loadHomeScreen():
    ...
    dev_b = Button(homeFrame,text='Developed By Md Md Ajhar',font=('',8),background=main_Background,command=lambda:(webbrowser.open('github.com/BlackTheives/', new=0, autoraise=True)),relief=FLAT,activebackground=main_Background)
